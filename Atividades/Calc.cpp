...
// ---------------------------------------------------------------------------
__fastcall TCalculadora::TCalculadora(TComponent* Owner) : TForm(Owner) {
}
// ---------------------------------------------------------------------------
...
void __fastcall TCalculadora::FormKeyDown(TObject *Sender, WORD &Key,
		TShiftState Shift) {
...
void __fastcall TCalculadora::FormKeyUp(TObject *Sender, WORD &Key,
		TShiftState Shift)
...
void __fastcall TCalculadora::ButtonApagarClick(TObject *Sender) {
	ButtonedEditValor->Text = ButtonedEditValor->Text.SubString(0,
			ButtonedEditValor->Text.Length() - 1);
	Foco();
}
// ---------------------------------------------------------------------------

void __fastcall TCalculadora::FormKeyPress(TObject *Sender,
		System::WideChar &Key)
